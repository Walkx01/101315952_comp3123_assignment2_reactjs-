...
export default function Employee() {
  ...
  const [vieEMpDetail, setviewEmpDetail] = useState(false);
  var idselected = null;
  ...
  if (loggedInUser) {
    if (vieEMpDetail) {
      return <ViewEmployee props={idselected} />;
    } else {
      if (employeeList) {
        return (
                  ...
                  {employeeList.map((val) => (
                    <tr key={val._id}>
                      ...
                      <td id="emp-action">
                        ...
                        <button onClick={(e) => showemployee(val._id)}>
                          view
                        </button>
                      </td>
                    </tr>
        ...
        return (
          <div id="emp-container">
            ...
            <div id="no-emp-bottom">
              ...
              <div>
                <h4>
                  looks like we don't have any employees in our system to
                  display
                </h4>
